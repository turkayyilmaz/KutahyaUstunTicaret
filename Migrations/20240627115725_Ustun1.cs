...
{
    /// <inheritdoc />
    public partial class Ustun1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Navbars", x => x.NavbarId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TopLineId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TopLines", x => x.TopLineId);
                });
